...
import { dataProvider } from '@core/lib/data-provider'
...
import type { NavGroup, PluginManifest, PluginRoute } from '@core/types/plugin'

import UnauthorizedPage from '@core/pages/unauthorized'
...
class ErrorBoundary extends Component<{ children: ReactNode }, { error: Error | null }> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div className="p-6 font-mono whitespace-pre-wrap text-destructive">
